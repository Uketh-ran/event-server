...
import WedLiveMusicModal from "./WedLiveMusicModal";
...
const deleteImage = async (imgName) => {
  ...
  return (
    <div className="container py-4">
      <h2 className="text-center mb-4">Wedding LiveMusic - Admin Panel</h2>
      ...
      <WedLiveMusicModal show={showModal} onHide={() => setShowModal(false)} refresh={fetchData} existing={data} />
    </div>
  );
};

export default WedLiveMusic;
